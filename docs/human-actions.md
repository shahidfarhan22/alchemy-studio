...
| # | Action | Why | Status |
|---|---|---|---|
| 11 | Review and approve the drafted legal pages (Privacy Policy, Terms, Refund/Shipping policy) — drafts, not legal advice. Live at `/privacy`, `/terms`, `/refund-policy` | Razorpay requires these live before activating a real account. | done — PR #25 merged |
